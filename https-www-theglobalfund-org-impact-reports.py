...
driver.get("https://www.theglobalfund.org/en/publications/impact-reports/")
url = "https://www.theglobalfund.org"
articles = driver.find_elements_by_xpath('//*[@id="13945"]/li/small/a')
for i in range(len(articles)):
	print("-----------------------------------------------------------------------------------------------------------")
	print(articles[i].get_attribute('href'))

articles = driver.find_elements_by_xpath('//*[@id="13980"]/li/small/a')
for i in range(len(articles)):
	print("-----------------------------------------------------------------------------------------------------------")
	print(articles[i].get_attribute('href'))
